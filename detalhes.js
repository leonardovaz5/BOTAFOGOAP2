if (sessionStorage.getItem('logado')) {
    ...
    const montaPagina = (dados) => {
        ...
        voltar.style.color = 'white'; // Cor do texto
        voltar.style.backgroundColor = 'black'; // Cor de fundo
        voltar.style.padding = '10px 20px'; // Adiciona padding
        voltar.style.borderRadius = '5px'; // Bordas arredondadas
        voltar.style.textDecoration = 'none'; // Remove sublinhado
        voltar.style.display = 'inline-block'; // Para que o padding funcione corretamente
